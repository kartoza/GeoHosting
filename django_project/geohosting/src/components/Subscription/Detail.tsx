                ...
                data && !loading && !error && <>
                  <Table w='100%'>
                    ...
                    <Tr>
                      ...
                      <Td px={4}>{data.is_active ? 'Active' : 'Not active'}</Td>
                    </Tr>
                    <Tr>
                      <Td className='table-title'>Expires on: </Td>
                      <Td px={4}>
                        {data.current_expiry_at.split(' ')[0]} UTC
                      </Td>
                    </Tr>
                    <Tr>
                    ...
                    <Tr>
                      ...
                      <Td px={4}>{data.amount} {data.currency}</Td>
                    </Tr>
                    <Tr>
                    ...
                    {/* PAYMENT */}
                    {
                      ...
                      <Tr>
                        ...
                        <Td px={4}>
                          ...
                          <Box>
                            {data.billing_detail.card.exp_month}/{data.billing_detail.card.exp_year}
                          </Box>
                        </Td>
                      </Tr>
                    }
